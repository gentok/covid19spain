#' ---
#' title: "Import Census Files for Calalonia"
#' author: "Gento Kato"
#' date: "April 17, 2020"
#' ---
...
# 2011 Census Data
ce <- read.csv("../data/shapefile/national_data/indicadores_seccion_censal_csv/C2011_ccaa09_Indicadores.csv",
...
ce_mun[nrow(ce_mun)+1,] <- NA
ce_mun$mundesc[nrow(ce_mun)] <- "(altres municipis)"

saveRDS(ce_mun, "../data/census2011_cataluna.rds")
